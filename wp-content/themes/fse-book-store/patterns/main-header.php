...
<?php if ( class_exists( 'WooCommerce' ) ) { ?>
    <!-- wp:woocommerce/customer-account {"iconClass":"wc-block-customer-account__account-icon","textColor":"background","style":{"spacing":{"padding":{"right":"0","left":"0","top":"0","bottom":"0"}},"elements":{"link":{"color":{"text":"var:preset|color|background"}}}}} /-->
<?php } else { ?> 
